...
String apiKey = "1EU7EVV7BXC8Q757";
...
void esp_8266()
{
  // GET https://api.thingspeak.com/update?api_key=1EU7EVV7BXC8Q757&field1=0
...
// delay(2000);
  ...
  jsonDocument["pulse"] = BPM;
  jsonDocument["ecg"] = ecg;
